...
<div class="ml-64 p-8">
    ...
    <a href="add.php" class="mb-4 inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ New Hearing</a>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <a href="view.php?id=<?php echo $hearing['id']; ?>" class="text-blue-600 hover:underline mr-2">View</a>
                        <a href="edit.php?id=<?php echo $hearing['id']; ?>" class="text-yellow-600 hover:underline mr-2">Edit</a>
                        <a href="delete.php?id=<?php echo $hearing['id']; ?>" class="text-red-600 hover:underline" onclick="return confirm('Are you sure you want to delete this hearing?');">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
